...
export default function Home() {
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "ai", content: "Sorry, I am having trouble connecting to the server.", id: Date.now().toString() },
      ]);
    } finally {
      setIsLoading(false);
    }
      ...
      <main className={styles.chatWindow}>
        <div className={styles.messageList}>
          <AnimatePresence>
            ...
            {isLoading && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className={styles.aiMessageWrapper}>
